...
from videocortex.config import FSAVERAGE5_VERTICES
...
def test_region_map_is_unique_and_complete():
    from videocortex.regions import load_region_labels
...
def test_palette_index_brackets_and_clamps():
    from videocortex.spin import palette_index_frac
...
def test_blend_palettes_is_a_lerp():
    from videocortex.spin import blend_palettes
...
def test_soft_ramp_fades_where_hard_cut_pops():
    from videocortex.render import soft_threshold_cmap
...
def test_energy_curve_is_mean_abs_per_tr():
    from videocortex.render import energy_curve
...
def test_ribbon_blits_and_playshead_moves():
    from videocortex.render import blit_ribbon, draw_energy_ribbon, energy_curve
...
def test_feather_softens_the_silhouette():
    from videocortex.spin import feather_alpha
