...
One job at a time. A render is tens of minutes of Metal; overlay is shorter
but still not something to pile up. The HTTP layer polls; a worker thread
...
def _run_overlay(job_id: str, params: dict[str, Any]) -> dict[str, Any]:
    from videocortex.overlay import overlay_from_run
