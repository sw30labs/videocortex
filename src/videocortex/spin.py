...
from videocortex.config import FSAVERAGE5_VERTICES, OverlayConfig
from videocortex.overlay import OverlayError, plate_index_at
from videocortex.render import compute_limits, format_pip_label, load_fsaverage5
